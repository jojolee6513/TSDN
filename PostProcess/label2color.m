...
switch lower(data_name)
        case 'houston2013'
        map=[127 0 0;255 0 0;255 0 255;190 170 92; 102 255 0;0 190 190;0 255 255;0 0 255;78 162 241;120 171 48;125 46 143;237 176 33;217 84 26;0 115 189;230 230 230];
        for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(1)
